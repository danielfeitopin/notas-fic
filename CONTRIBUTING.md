# Contributing to Notas-FIC

Thank you for your interest in contributing to [Notas-FIC](<https://github.com/danielfeitopin/notas-fic>)! We appreciate your time and effort in helping improve this project.
...
- **Issues**: Review the [Issues](https://github.com/danielfeitopin/notas-fic/issues) section to see if your concern has already been reported.
- **Pull Requests**: Review the [Pull Requests](https://github.com/danielfeitopin/notas-fic/pulls) section to see if a similar contribution is already in progress.
- **Discussions**: Check the [Discussions](https://github.com/danielfeitopin/notas-fic/discussions) section for ongoing conversations about your topic.

## How to Contribute

### To Report Bugs
1. Search the [Issues](https://github.com/danielfeitopin/notas-fic/issues) to ensure the bug hasn’t already been reported.
...
1. Check the [Issues](https://github.com/danielfeitopin/notas-fic/issues) and [Discussions](https://github.com/danielfeitopin/notas-fic/discussions) to see if your idea has already been proposed.
...
Thank you for contributing to Notas-FIC!